...
function RegisterPage(): ReactNode {
  ...
  const submit = (event: SubmitEvent) => {
    ...
    api
      .post<AuthResponse>("/api/public/auth/register", authData)
      .then((resp) => {
  ...
  return (
    <div className="min-h-dvh container flex place-content-center items-center mx-auto">
      <form onSubmit={submit} className="border bg-white dark:bg-gray-900 p-6">
        <h1 className="font-bold text-center text-2xl my-4">Register</h1>
        <div className="mb-4">
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            placeholder="Enter your password (min length 8)..."
        ...
        <p className="text-center mb-4">
          ...
          <br />
          Login{" "}
          <a href="/login" className="font-medium text-emerald-500">
            here
          </a>
          .
        </p>
